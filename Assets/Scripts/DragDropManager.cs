...
public class DragDropManager : MonoBehaviour
{
    ...
    private IEnumerator endMatch(int levelId, int score)
    {
        if (GameManager.instance != null)
        {
            yield return StartCoroutine(GameManager.instance.EndMatch(levelId, score));
        } else {
